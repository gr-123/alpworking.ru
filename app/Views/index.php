    ...
    <style {csp-style-nonce}>
        ...
        *:focus {
        ...
        figure.images {
            ...
            /*font-family:"Courier New", Courier, monospace; font-size:12px; margin-top:2px; color:#FFFFFF; text-shadow: 0px -1px 0px #374683;*/
        ...
        figure.images figcaption.name {
            color: #067703;
            /* Цвет текста */
        }

        figure.images figcaption.description {
            color: navy;
            /* Цвет текста */
        }
...
<body>
    ...
    <header>
        ...
        <div class="menu">
            <ul>
                ...
                <li class="menu-item hidden"><a href="<?= url_to('admin.home') ?>">Admin</a></li>
        ...
        <div class="heroe">
            ...
            <h2><i>Промышленный альпинист</i></h2>
        </div>
    </header>
    ...
    <section>
        ...
        <?php foreach ($categories as $item) : ?>
            <a href="<?= url_to('category.' . esc($item->name)) ?>"><?= esc($item->title) ?></a> <small><i>от 200 р/м.п</i></small><br>
        <?php endforeach ?>
    </section>
