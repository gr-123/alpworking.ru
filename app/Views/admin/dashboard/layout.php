...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Промальп работы</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= route_to('admin.manager'); ?>" class="nav-link <?= (current_url() == base_url('admin/manager')) ? 'active' : ''; ?>">
              <i class="nav-icon fas fa-user"></i>
              <p>
                Manager
              </p>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2014-2021 <a href="<? base_url(); ?>">Промальп работы</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
